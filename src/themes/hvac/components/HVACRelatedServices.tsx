...
import { Thermometer, Wind, Settings, ArrowRight, Phone } from 'lucide-react';
            ...
            >
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
                  <div className="text-orange-600 bg-white rounded-full p-2 shadow-lg">
                    {service.icon}
                  </div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a 
                    href="tel:5551234567"
                    className="bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white px-4 py-2 rounded-full font-bold text-sm transition-all duration-300 flex items-center space-x-2 transform hover:scale-105 shadow-lg"
                  >
                    <Phone size={16} />
                    <span>Call</span>
                  </a>
