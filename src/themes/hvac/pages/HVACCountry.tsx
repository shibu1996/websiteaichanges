...
const HVACCountry = () => {
  ...
  return (
    <div className="min-h-screen font-poppins">
              ...
              <div key={index} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                ...
                {pageType !== 'local_area' && (
                  <button
                    ...
                    className="mt-6 w-full bg-gradient-to-r from-orange-600 to-red-600 text-white py-3 rounded-lg font-semibold hover:from-orange-700 hover:to-red-700 transition-all duration-300"
                  >
                    See Areas
                  </button>
                )}
      ...
      {pageType === 'country' && <ServiceMap theme="hvac" />}
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Got questions? We've got answers. Here are the most common questions about our HVAC services.
              </p>
            </div>
