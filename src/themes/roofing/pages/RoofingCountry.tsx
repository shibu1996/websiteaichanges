...
const RoofingCountry = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        switch (pageType) {
          case 'country':
            reqFrom = "roofingCountry";
            break;
          case 'state':
            reqFrom = "roofingState";
            break;
          case 'city':
            reqFrom = "roofingCity";
            break;
  ...
  return (
    <div className="min-h-screen font-poppins">
      ...
      {pageType === 'country' && <ServiceMap theme="roofing" />}
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Got questions? We've got answers. Here are the most common questions about our roofing services.
              </p>
            </div>
