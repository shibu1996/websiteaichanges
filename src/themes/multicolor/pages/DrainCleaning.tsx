    ...
    <HelmetProvider>
      ...
      <div className="min-h-screen font-poppins">
        ...
        <section
          ...
          style={{
            backgroundImage: `url(${displayServiceImage})`,
            ...
            <div className="text-center space-y-6 animate-hero-fade-in">
              ...
              <div className="space-y-3 animate-heading-slide-up" style={{ animationDelay: '0.2s' }}>
                <h1 className="text-primary-foreground leading-tight">
                  {locationName}
                  <span className="block md:inline text-transparent bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text animate-gradient-shift"> {displayServiceName} </span>
