...
const ServicesCTA = () => {
  return (
    <section className="section-full-width py-20 bg-gradient-to-b from-primary via-primary/95 to-primary transition-colors duration-300">
      <div className="container mx-auto px-16">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-primary via-primary/90 to-primary rounded-3xl p-8 text-primary-foreground relative overflow-hidden">
            ...
            <div className="relative text-center">
              <h3 className="text-3xl font-bold mb-4">Transform your world with our professional <span className="text-white">Plumbing</span> services</h3>
                  ...
                  <button className="relative bg-white/95 backdrop-blur-sm text-primary border-2 border-white/30 px-10 py-6 text-xl font-bold shadow-xl rounded-2xl transform hover:scale-105 transition-all duration-300 group hover:bg-white hover:text-primary">
                    <div className="relative flex items-center">
                      ...
                      <div className="flex flex-col items-start">
                        ...
                        <span className="text-xl font-black tracking-wide">Book Plumbing Services</span>
                      </div>
                    </div>
                  </button>
                </div>
