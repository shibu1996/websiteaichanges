  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        switch (pageType) {
          case 'country':
            reqFrom = "plumbingCountry";
            break;
          case 'state':
            reqFrom = "plumbingState";
            break;
          case 'city':
            reqFrom = "plumbingCity";
            break;
          case 'local_area':
            reqFrom = "plumbingArea";
            refLocation = slug;
            break;
        }
          ...
          {pageType === 'local_area' ? (
            <div className="text-center">
              <div className="flex items-center justify-center mb-4">
                <HeroIcon className="w-8 h-8 text-cyan-400 mr-3" />
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center mb-8">
                <a
                  href="tel:5551234567"
                  className="group bg-cyan-400 hover:bg-cyan-500 text-white font-semibold py-3 px-8 rounded-2xl shadow-lg transition-all duration-300 flex items-center justify-center space-x-3"
                >
            ...
            {projectLocations.map((area, index) => (
              <div key={index} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center text-gray-600">
                    <Shield className="w-5 h-5 text-cyan-500 mr-3" />
                ...
                {pageType !== 'local_area' && (
                  <button
                    ...
                    className="mt-6 w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-cyan-700 transition-all duration-300"
                  >
                    See Areas
                  </button>
                )}
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Got questions? We've got answers. Here are the most common questions about our plumbing services.
              </p>
            </div>
